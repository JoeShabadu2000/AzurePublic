...
#
# Defaults to a B1s instance with 1 CPU and 1G RAM. Using Ubuntu 20.04 since 22.04 not currently suppored by mongodb.
#
...
$publicIPDomainName = "tabula$projectName"  ## DNS name for public IP (will concatenate [name].[region].cloudapp.azure.com) - must be global unique
